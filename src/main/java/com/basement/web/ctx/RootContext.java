...
@Configuration
@MapperScan(basePackages = {"com.basement.web"})
@ComponentScan(basePackages ={"com.basement.web"})
...
//		dataSource.setUrl("jdbc:mysql://localhost:3306/basement?serverTimezone=UTC");
//		dataSource.setUsername("basement");
//		dataSource.setPassword("basement");